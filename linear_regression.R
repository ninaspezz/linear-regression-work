...
energy.mod2 <- lm(energy ~ metro + density + waste + 
                    toxic + green, data=states.data)
summary(energy.mod2)

energy.mod3 <- lm(energy ~ toxic + green, data=states.data)
summary(energy.mod3)
...
energy.toxic.by.green <- lm(energy ~ toxic*green,
                             data=states.data) 
coef(summary(energy.toxic.by.green))

##   2. Try adding region to the model. Are there significant differences
##      across the four regions?
energy.mod4 <- lm(energy ~ toxic + green + region, data=states.data)
summary(energy.mod4)